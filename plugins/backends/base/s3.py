...
#        ----------
#
#        config: Config dictionary (loaded ini file)
#
#        """
#        config = get_config() 
#        self._session = boto3.Session(aws_access_key_id=config['aws']['access'],
...
#        """
#        The configuraiton required for s3 is specified in the state object.  
#        """
...
#    
#        if len(matching) > 1: 
#            print("Multiple datasets are matching. Please specify")
#            print([d['name'] for d in matching])
#            sys.exit()            
#    
#        d = matching[0] 
#    
#        bucket = state['config']['storage']['bucket']
#        prefix = state['config']['storage']['prefix']
#
#        relativepath = d['storage']['relativepath'] 
#        files = d['files']
#        for f in files:         
#            print("Uploading ", f) 
#            localpath = f['localpath']
#            targetpath = os.path.join(prefix, relativepath, f['filename'])
#            print(localpath,"=>",targetpath)
#            result = self._s3.meta.client.upload_file(localpath, 
#                                                      bucket,
#                                                      targetpath)
#
#    def pull(self, state, name): 
#        """
#        Pull from the s3 
#        """
